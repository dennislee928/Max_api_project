...
export default {
  ...
  async mounted() {
    try {
      const response = await fetch(
        'https://cors-anywhere.herokuapp.com/https://max-api.maicoin.com/api/v3/markets'
      )
      if (!response.ok) {
  ...
  methods: {
    async fetchData() {
      try {
        const url = 'https://cors-anywhere.herokuapp.com/https://max-api.maicoin.com/api/v3/markets'
